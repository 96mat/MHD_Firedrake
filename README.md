...
## :one: $H^1(\Omega)/H(curl;\Omega)$ and $H(div;\Omega)/H(div;\Omega)$ and MHD: only Resistive
...
$$H(div;\Omega)=\lbrace \bar{v}\in L^2(\Omega): \nabla\cdot \bar{v} \in L^2(\Omega)\rbrace\rightarrow \bar{v}\cdot \hat{n}=\bar{g}\vert_{\partial\Omega}$$ </br>
$$H(curl;\Omega)=\lbrace \bar{v}\in L^2(\Omega): \nabla\times \bar{v} \in L^2(\Omega)\rbrace \rightarrow \bar{v}\times \hat{n}=\bar{g}\vert_{\partial\Omega}$$</br>
...
## :two: $H(div;\Omega)/H(curl;\Omega)$ compatible spaces and MHD: comprising the Hall's Term
